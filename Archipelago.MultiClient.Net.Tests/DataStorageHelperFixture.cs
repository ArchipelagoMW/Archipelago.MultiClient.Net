    ...
    class DataStorageHelperFixture
    {
        ...
        public static TestCaseData[] CompoundAssignmentTests =>
            new TestCaseData[] {
                new CompoundAssignmentTest<int>("Assignment", 30, (sut, key, value) => sut[key] = value,
                    (p, key, value) => p.Key == key && (int)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Replace.ToString().ToString()),
                new CompoundAssignmentTest<long>("Assignment", 300L, (sut, key, value) => sut[key] = value,
                    (p, key, value) => p.Key == key && (long)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Replace.ToString()),
                new CompoundAssignmentTest<decimal>("Assignment", 3.003m, (sut, key, value) => sut[key] = value,
                    (p, key, value) => p.Key == key && (decimal)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Replace.ToString()),
                new CompoundAssignmentTest<double>("Assignment", 3.03d, (sut, key, value) => sut[key] = value,
                    (p, key, value) => p.Key == key && (double)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Replace.ToString()),
                new CompoundAssignmentTest<float>("Assignment", 3f, (sut, key, value) => sut[key] = value,
                    (p, key, value) => p.Key == key && (float)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Replace.ToString()),
                new CompoundAssignmentTest<string>("Assignment", "test", (sut, key, value) => sut[key] = value,
                    (p, key, value) => p.Key == key && (string)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Replace.ToString()),
                new CompoundAssignmentTest<bool>("Assignment", true, (sut, key, value) => sut[key] = value,
                    (p, key, value) => p.Key == key && (bool)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Replace.ToString()),
                new CompoundAssignmentTest<bool[]>("Assignment", new []{ true, false }, (sut, key, value) => sut[key] = value,
                    (p, key, value) => p.Key == key && p.Operations[0].Operation == Operation.Replace .ToString()&& p.Operations[0].Value is JArray),
                ...
                new CompoundAssignmentTest<int>("Inplace Addition", 10, (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && (int)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Add.ToString()),
                new CompoundAssignmentTest<long>("Inplace Addition", 300L, (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && (long)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Add.ToString()),
                new CompoundAssignmentTest<decimal>("Inplace Addition", 3.003m, (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && (decimal)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Add.ToString()),
                new CompoundAssignmentTest<double>("Inplace Addition", 3.03d, (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && (double)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Add.ToString()),
                new CompoundAssignmentTest<float>("Inplace Addition", 3f, (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && (float)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Add.ToString()),
                new CompoundAssignmentTest<string>("Inplace Addition", "test", (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && (string)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Add.ToString()),
                new CompoundAssignmentTest<IList>("Inplace Addition", new []{ 1, 2 }, (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && p.Operations[0].Operation == Operation.Add .ToString()&& p.Operations[0].Value is JArray),
                ...
                new CompoundAssignmentTest<OperationSpecification>("Inplace Addition", Bitwise.Xor(0xFF), (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && p.Operations[0].Operation == Operation.Xor .ToString()&& p.Operations[0].Value == value.Value),
                new CompoundAssignmentTest<OperationSpecification>("Inplace Addition", Bitwise.Or(0x00F0), (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && p.Operations[0].Operation == Operation.Or .ToString()&& p.Operations[0].Value == value.Value),
                new CompoundAssignmentTest<OperationSpecification>("Inplace Addition", Bitwise.And(0b01011), (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && p.Operations[0].Operation == Operation.And .ToString()&& p.Operations[0].Value == value.Value),
                new CompoundAssignmentTest<OperationSpecification>("Inplace Addition", Bitwise.LeftShift(4), (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && p.Operations[0].Operation == Operation.LeftShift .ToString()&& p.Operations[0].Value == value.Value),
                new CompoundAssignmentTest<OperationSpecification>("Inplace Addition", Bitwise.RightShift(8), (sut, key, value) => sut[key] += value,
                    (p, key, value) => p.Key == key && p.Operations[0].Operation == Operation.RightShift .ToString()&& p.Operations[0].Value == value.Value),
                ...
                new CompoundAssignmentTest<int>("Inplace Multiplication", 10, (sut, key, value) => sut[key] *= value,
                    (p, key, value) => p.Key == key && (int)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Mul.ToString()),
                new CompoundAssignmentTest<long>("Inplace Multiplication", 300L, (sut, key, value) => sut[key] *= value,
                    (p, key, value) => p.Key == key && (long)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Mul.ToString()),
                new CompoundAssignmentTest<decimal>("Inplace Multiplication", 3.003m, (sut, key, value) => sut[key] *= value,
                    (p, key, value) => p.Key == key && (decimal)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Mul.ToString()),
                new CompoundAssignmentTest<double>("Inplace Multiplication", 3.03d, (sut, key, value) => sut[key] *= value,
                    (p, key, value) => p.Key == key && (double)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Mul.ToString()),
                new CompoundAssignmentTest<float>("Inplace Multiplication", 3f, (sut, key, value) => sut[key] *= value,
                    (p, key, value) => p.Key == key && (float)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Mul.ToString()),
                new CompoundAssignmentTest<int>("Inplace Division", 10, (sut, key, value) => sut[key] /= value,
                    (p, key, value) => p.Key == key && (decimal)p.Operations[0].Value == 1m/value && p.Operations[0].Operation == Operation.Mul.ToString()),
                ...
                new CompoundAssignmentTest<double>("Inplace Division", 3.03d, (sut, key, value) => sut[key] /= value,
                    (p, key, value) => p.Key == key && (double)p.Operations[0].Value == 1d/value && p.Operations[0].Operation == Operation.Mul.ToString()),
                ...
                new CompoundAssignmentTest<int>("Inplace Modulus", 10, (sut, key, value) => sut[key] %= value,
                    (p, key, value) => p.Key == key && (int)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Mod.ToString()),
                new CompoundAssignmentTest<long>("Inplace Modulus", 300L, (sut, key, value) => sut[key] %= value,
                    (p, key, value) => p.Key == key && (long)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Mod.ToString()),
                new CompoundAssignmentTest<decimal>("Inplace Modulus", 3.003m, (sut, key, value) => sut[key] %= value,
                    (p, key, value) => p.Key == key && (decimal)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Mod.ToString()),
                new CompoundAssignmentTest<double>("Inplace Modulus", 3.03d, (sut, key, value) => sut[key] %= value,
                    (p, key, value) => p.Key == key && (double)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Mod.ToString()),
                new CompoundAssignmentTest<float>("Inplace Modulus", 3f, (sut, key, value) => sut[key] %= value,
                    (p, key, value) => p.Key == key && (float)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Mod.ToString()),
                new CompoundAssignmentTest<int>("Inplace Exponentiation", 10, (sut, key, value) => sut[key] ^= value,
                    (p, key, value) => p.Key == key && (int)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Pow.ToString()),
                new CompoundAssignmentTest<long>("Inplace Exponentiation", 300L, (sut, key, value) => sut[key] ^= value,
                    (p, key, value) => p.Key == key && (long)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Pow.ToString()),
                new CompoundAssignmentTest<decimal>("Inplace Exponentiation", 3.003m, (sut, key, value) => sut[key] ^= value,
                    (p, key, value) => p.Key == key && (decimal)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Pow.ToString()),
                new CompoundAssignmentTest<double>("Inplace Exponentiation", 3.03d, (sut, key, value) => sut[key] ^= value,
                    (p, key, value) => p.Key == key && (double)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Pow.ToString()),
                new CompoundAssignmentTest<float>("Inplace Exponentiation", 3f, (sut, key, value) => sut[key] ^= value,
                    (p, key, value) => p.Key == key && (float)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Pow.ToString()),
                new CompoundAssignmentTest<int>("Postfix Addition", 0, (sut, key, value) => sut[key]++,
                    (p, key, value) => p.Key == key && (int)p.Operations[0].Value == 1 && p.Operations[0].Operation == Operation.Add.ToString()),
                ...
                new CompoundAssignmentTest<int>("Inplace Maximum", 10, (sut, key, value) => sut[key] <<= value,
                    (p, key, value) => p.Key == key && (int)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Max.ToString()),
                new CompoundAssignmentTest<int>("Inplace Minimum", 10, (sut, key, value) => sut[key] >>= value,
                    (p, key, value) => p.Key == key && (int)p.Operations[0].Value == value && p.Operations[0].Operation == Operation.Min.ToString())
            };
        ...
        public void Different_scopes_should_not_interfere()
        {
            ...
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "A" && p.Operations[0].Operation == Operation.Replace.ToString() && (string)p.Operations[0].Value == "global"));
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "Game:UnitTest:A" && p.Operations[0].Operation == Operation.Replace.ToString() && (string)p.Operations[0].Value == "game"));
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "Team:5:A" && p.Operations[0].Operation == Operation.Replace.ToString() && (string)p.Operations[0].Value == "team"));
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "Slot:12:A" && p.Operations[0].Operation == Operation.Replace.ToString() && (string)p.Operations[0].Value == "slot"));
        ...
        public void Should_correctly_handle_deplete()
        {
            ...
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "DP1" && p.WantReply == true && p.Operations.Length == 2
                    && p.Operations[0].Operation == Operation.Add .ToString()&& (decimal)p.Operations[0].Value == 50m
                    && p.Operations[1].Operation == Operation.Max .ToString()&& (int)p.Operations[1].Value == 0));
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "DP2" && p.WantReply == true && p.Operations.Length == 2
                     && p.Operations[0].Operation == Operation.Add .ToString()&& (decimal)p.Operations[0].Value == -11.53m
                     && p.Operations[1].Operation == Operation.Max .ToString()&& (int)p.Operations[1].Value == 0));
        ...
        public void Should_handle_complex_opperations()
        {
            ...
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "A" && p.Operations.Length == 2
                    && p.Operations[0].Operation == Operation.Add .ToString()&& (int)p.Operations[0].Value == -10
                    && p.Operations[1].Operation == Operation.Max .ToString()&& (int)p.Operations[1].Value == 0));
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "B" && p.Operations.Length == 4
                    && p.Operations[0].Operation == Operation.Add .ToString()&& (int)p.Operations[0].Value == 5
                    && p.Operations[1].Operation == Operation.Mul .ToString()&& (int)p.Operations[1].Value == 8
                    && p.Operations[2].Operation == Operation.Mul .ToString()&& (decimal)p.Operations[2].Value == 0.5m
                    && p.Operations[3].Operation == Operation.Add .ToString()&& (int)p.Operations[3].Value == -3));
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "C" && p.Operations.Length == 5
                    && p.Operations[0].Operation == Operation.Replace .ToString()&& (int)p.Operations[0].Value == 100
                    && p.Operations[1].Operation == Operation.And .ToString()&& (int)p.Operations[1].Value == 0xFF
                    && p.Operations[2].Operation == Operation.Mul .ToString()&& (int)p.Operations[2].Value == 8
                    && p.Operations[3].Operation == Operation.Mul .ToString()&& (decimal)p.Operations[3].Value == 0.5m
                    && p.Operations[4].Operation == Operation.Add .ToString()&& (int)p.Operations[4].Value == -3));
        }
        ...
        public void Should_send_custom_objects()
        {
            ...
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "Item" && p.Operations[0].Operation == Operation.Replace .ToString()&& p.Operations[0].Value is JObject));
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "Anonymous" && p.Operations[0].Operation == Operation.Replace .ToString()&& p.Operations[0].Value is JObject));
        }
        ...
        public void Should_set_default()
        {
            ...
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "A" && p.Operations[0].Operation == Operation.Default .ToString()&& (int)p.DefaultValue == 20));
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "B" && p.Operations[0].Operation == Operation.Default .ToString()&& p.DefaultValue is JArray));
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "C" && p.Operations[0].Operation == Operation.Default .ToString()&& p.DefaultValue is JArray));
            socket.Received().SendPacketAsync(Arg.Is<SetPacket>(
                p => p.Key == "D" && p.Operations[0].Operation == Operation.Default .ToString()&& (string)p.DefaultValue == ""));
        }
