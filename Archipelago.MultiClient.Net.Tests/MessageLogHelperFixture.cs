        ...
        public void Should_convert_print_json_packet_into_string()
        {
            ...
            var packet = new PrintJsonPacket
            {
                ...
                Data = new[] {
                    ...
                    new JsonMessagePart { Type = "text", Text = "Text2" },
                    new JsonMessagePart { Type = "color", Text = "Text3", Color = "blue" },
                    new JsonMessagePart { Type = "item_id", Text = "4", Flags = ItemFlags.None },
                    new JsonMessagePart { Type = "item_name", Text = "Text5" },
                    new JsonMessagePart { Type = "location_id", Text = "6" },
                    new JsonMessagePart { Type = "location_name", Text = "Text7" },
                    new JsonMessagePart { Type = "player_id", Text = "8" },
                    new JsonMessagePart { Type = "player_name", Text = "Text9" },
                    new JsonMessagePart { Type = "entrance_name", Text = "Text10" }
                }
#else
                Data = new[] {
                    new JsonMessagePart { Type = null, Text = "Text1" },
        ...
        public void Should_get_parsed_data_for_print_json_packet()
        {
            ...
            var packet = new PrintJsonPacket
            {
                ...
                Data = new[] {
                    new JsonMessagePart { Type = null, Text = "Text1" },
                    new JsonMessagePart { Type = "text", Text = "Text2" },
                    new JsonMessagePart { Type = "color", Text = "Text3", Color = "blue_bg" },
                    new JsonMessagePart { Type = "item_id", Text = "4", Flags = ItemFlags.None },
                    new JsonMessagePart { Type = "item_name", Text = "Text5" },
                    new JsonMessagePart { Type = "location_id", Text = "6" },
                    new JsonMessagePart { Type = "location_name", Text = "Text7" },
...
#if NET472
                Data = new[] {
                    new JsonMessagePart { Type = "player_id", Text = "4" }
                }
#else
                Data = new[] {
...
#if NET472
                Data = new[] {
                    new JsonMessagePart { Type = "item_id", Text = "1", Flags = itemFlags },
                    new JsonMessagePart { Type = "item_name", Text = "ItemFive", Flags = itemFlags }
                }
#else
                Data = new[] {
...
#if NET472
                Data = new[] {
                    new JsonMessagePart { Type = "color", Color = "red", Text = "Some text\nover multiple "},
